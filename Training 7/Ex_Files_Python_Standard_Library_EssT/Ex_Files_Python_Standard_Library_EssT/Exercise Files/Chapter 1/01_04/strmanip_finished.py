...
# splits string where the slit contant is located, in this case in every space and it will create multiplle short strings of where the spoaces are
result = test_string1.split(" ")
print(result)

letters = ["a", "b", "c", "d", "e"] # does the opposote spli
print(", ".join(letters))
