...
print(bisect.bisect(values, 25)) # will give index at which order position the value would be inserted to maintain order 
print(bisect.bisect_right(values, 25))

print(bisect.bisect_left(values, 25))

"""
It is also possible to use insort left to do the same and insert from the left
